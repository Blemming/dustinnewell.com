<template lang="html">
        ...
        <div class="columns is-centered">
            <div class="column is-two-thirds has-text-centered">
                ...
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    width="1000px" height="1000px" viewBox="50 180 800 800" class="" enable-background="new 0 0 1000 1000" xml:space="preserve">
                    <rect id="bg" x="-29" y="-37" fill="#FFF" width="1064" height="1073" />
	...
	c0,0,41.866,32.557,184.5,32.557S655,426.5,655,426.5V807.654z" />
		...
		c0,21.232,82.604,38.444,184.5,38.444S655,444.288,655,423.056C655,401.824,572.396,384.612,470.5,384.612L470.5,384.612z"
                ...
                <h1 class="title is-danger">404 Not found</h1>
                </section>
            </div>
        </div>
...
#steam {
  opacity: .5;
  -webkit-animation: fade 6s infinite ease-out;
}
